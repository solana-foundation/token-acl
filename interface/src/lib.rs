...
pub fn collect_thaw_extra_account_metas(
    mint: &Pubkey,
) -> [&[u8]; 2] {
    [THAW_EXTRA_ACCOUNT_METAS_SEED, mint.as_ref()]
}

pub fn collect_freeze_extra_account_metas(
    mint: &Pubkey,
) -> [&[u8]; 2] {
...
pub fn get_thaw_extra_account_metas_address(
    mint: &Pubkey,
    program_id: &Pubkey,
) -> Pubkey {
...
pub fn get_freeze_extra_account_metas_address(
    mint: &Pubkey,
    program_id: &Pubkey,
) -> Pubkey {
