...
import { FlagAccountSeeds, findFlagAccountPda } from '../pdas';

export type FlagAccount = { isThawing: boolean };

export type FlagAccountArgs = FlagAccount;

export function getFlagAccountEncoder(): Encoder<FlagAccountArgs> {
  return getStructEncoder([['isThawing', getBooleanEncoder()]]);
}

export function getFlagAccountDecoder(): Decoder<FlagAccount> {
  return getStructDecoder([['isThawing', getBooleanDecoder()]]);
}

export function getFlagAccountCodec(): Codec<FlagAccountArgs, FlagAccount> {
