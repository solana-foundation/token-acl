...
pub const THAW_PERMISSIONLESS_IDEMPOTENT_DISCRIMINATOR: u8 = 9;

/// Accounts.
#[derive(Debug)]
pub struct ThawPermissionlessIdempotent {
...
impl ThawPermissionlessIdempotent {
...
pub struct ThawPermissionlessIdempotentInstructionData {
    discriminator: u8,
}
...
impl Default for ThawPermissionlessIdempotentInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ThawPermissionlessIdempotent`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct ThawPermissionlessIdempotentBuilder {
...
impl ThawPermissionlessIdempotentBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = ThawPermissionlessIdempotent {
...
/// `thaw_permissionless_idempotent` CPI accounts.
pub struct ThawPermissionlessIdempotentCpiAccounts<'a, 'b> {
...
/// `thaw_permissionless_idempotent` CPI instruction.
pub struct ThawPermissionlessIdempotentCpi<'a, 'b> {
...
impl<'a, 'b> ThawPermissionlessIdempotentCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ThawPermissionlessIdempotentCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ThawPermissionlessIdempotent` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   8. `[]` gating_program
#[derive(Clone, Debug)]
pub struct ThawPermissionlessIdempotentCpiBuilder<'a, 'b> {
    instruction: Box<ThawPermissionlessIdempotentCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ThawPermissionlessIdempotentCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ThawPermissionlessIdempotentCpiBuilderInstruction {
            __program: program,
            authority: None,
            mint: None,
            token_account: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ThawPermissionlessIdempotentCpi {
...
#[derive(Clone, Debug)]
struct ThawPermissionlessIdempotentCpiBuilderInstruction<'a, 'b> {
