...
impl FreezePermissionlessIdempotent {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = FreezePermissionlessIdempotentInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct FreezePermissionlessIdempotentInstructionData {
    discriminator: u8,
}

impl FreezePermissionlessIdempotentInstructionData {
    pub fn new() -> Self {
...
impl Default for FreezePermissionlessIdempotentInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `FreezePermissionlessIdempotent`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
impl FreezePermissionlessIdempotentBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = FreezePermissionlessIdempotent {
...
/// `freeze_permissionless_idempotent` CPI accounts.
pub struct FreezePermissionlessIdempotentCpiAccounts<'a, 'b> {
...
/// `freeze_permissionless_idempotent` CPI instruction.
pub struct FreezePermissionlessIdempotentCpi<'a, 'b> {
...
impl<'a, 'b> FreezePermissionlessIdempotentCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: FreezePermissionlessIdempotentCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `FreezePermissionlessIdempotent` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
impl<'a, 'b> FreezePermissionlessIdempotentCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(FreezePermissionlessIdempotentCpiBuilderInstruction {
            __program: program,
            authority: None,
            mint: None,
            token_account: None,
...
#[derive(Clone, Debug)]
struct FreezePermissionlessIdempotentCpiBuilderInstruction<'a, 'b> {
